          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 grid md:grid-cols-2 gap-10 items-center">
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-2 mt-6">
                <button
                  className="px-8 py-3 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-lg font-semibold text-lg shadow hover:from-red-600 hover:to-red-800 transition-colors"
                  onClick={() => {
                    // Lưu thông tin món ăn vào localStorage để truyền sang trang thanh toán
            ...
            >
              <h1
                className="text-4xl md:text-4xl font-bold mb-4 text-gray-900"
                itemProp="name"
              >
                {food.name}
              </h1>
              <div className="flex items-center mb-4">
                <span
                  className="text-red-600 text-3xl font-bold mr-4"
                  itemProp="offers"
                  itemScope
              ...
              <div className="flex gap-3 items-center">
                ...
                <a
                  href="https://www.messenger.com/?locale=vi_VN"
                  className="hover:text-sky-400"
                  aria-label="Chia sẻ Messenger"
                >
                  Messenger<i className="fab fa-facebook-messenger"></i>
                </a>
                <a
